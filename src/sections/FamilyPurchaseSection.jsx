...
// ─── Section ──────────────────────────────────────────────────────────────────
const FamilyPurchaseSection = ({ state, update, updateMultiple, fredRate, fredDate, fredLoading, fredFailed, onFredRefresh }) => {
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-5 space-y-5">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-400 min-h-[1.5rem]">
              {fredLoading && (
                <>
                  ...
                  <span>Fetching live rate from FRED…</span>
                </>
              )}
              {!fredLoading && fredDate && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-0.5 rounded border border-slate-200 hover:border-slate-300 hover:text-slate-600 transition-colors"
                  >
              ...
              {!fredLoading && fredFailed && !fredDate && (
                <>
                  ...
                  <button
                    type="button"
                    onClick={onFredRefresh}
                    className="flex items-center gap-1 px-2 py-0.5 rounded border border-amber-200 text-amber-500 hover:border-amber-300 transition-colors"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                        d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
