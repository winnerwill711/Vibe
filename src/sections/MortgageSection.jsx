...
const MortgageSection = ({ state, update, updateMultiple, fredRate, fredDate, fredLoading, fredFailed, onFredRefresh }) => {
  ...
  return (
    <section id="mortgage" className="print-section scroll-mt-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        ...
        <div className="flex items-center gap-2 mt-2 text-xs text-slate-400 min-h-[1.5rem]">
          {fredLoading && (
            <>
